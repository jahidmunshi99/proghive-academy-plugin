<div class="wrap">
    <h1 class="wp-heading-inline"><?php _e( 'Batches', 'wepme' ); ?></h1>
    <a href="<?php echo admin_url( 'admin.php?page=proghive-plugin-batches&action=new' ); ?>" class="page-title-action"><?php _e( 'Create New Batch', 'wepme' ); ?></a>
    ...
    <form action="" method="post">
        ...
        <thead>
            <tr>
                ...
                <th class="manage-column column-title column-primary sortable desc" scope="col">
                    <label for=""><?php echo esc_html__('Course Type', 'proghive') ?></label>
                </th>
                <th class="manage-column column-title column-primary sortable desc" scope="col">
                    <label for=""><?php echo esc_html__('Seats', 'proghive') ?></label>
                </th>
                <th class="manage-column column-title column-primary sortable desc" scope="col">
                    <label for=""><?php echo esc_html__('Registration End Date', 'proghive') ?></label>
                </th>
                <th class="manage-column column-title column-primary sortable desc" scope="col">
        ...
        <?php 
             if( ! empty( $batch_info )){                
                ...
                <tr>
                    ...
                    <!-- End Email Column -->   
                    <!-- Batch Column Start -->  
                    <td class="title column-title has-row-actions column-primary page-title"><?php echo esc_html( $data->total_seat ) ?></td>      
                    <!-- End Batch Column --> 
                    <!-- User name Column Start -->  
                    <td class="title column-title has-row-actions column-primary page-title"><?php echo esc_html( $data->end_of_registration_date ) ?></td>      
